...
public class FileHelper {
    ...
    public static final String fileExtTXT = ".txt";
    ...
    public static boolean createMainDirectory(Context context) {
        String path;
        if (isStorageAvailable()) path = Environment.getExternalStorageDirectory().getPath();
        else path = context.getFilesDir().getPath();
        directory = new File(path + pathSeparator + context.getString(R.string.directory_name));
